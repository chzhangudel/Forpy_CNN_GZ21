...
def load_paper_net(device: str = 'gpu'):
    ...
    model_file = '/scratch/cimes/cz3321/MOM6/MOM6-examples/src/MOM6/config_src/external/ML_Forpy/Forpy_CNN_GZ21/trained_model_global_BC_8505.pth'
    # ---------------------------------------------------- #
...
def load_paper_net2(device: str = 'gpu'):
    """
        Load the neural network from the paper
    """
    print('In load_paper_net()')
